...
<div class="centralizar">
    <main class="fundinho" id="historia">
        <div>
            <H3>História de um grande sonhador</H3>

            <h2>A Origem: </h2>
            <p>
                A história da Build's Burger remonta a uma pequena cozinha caseira, onde o fundador, Guilherme,
                experimentava as receitas de hambúrgueres desde os tempos de faculdade. O amor pela gastronomia
                e o
            ...
            <p>
                ...
                Com um
                empréstimo modesto e uma pequena equipe formada por amigos e familiares, a primeira Build's
                Burger
                abriu
            ...
            <p>
                ...
                problemas de
                fornecimento de ingredientes até questões de marketing, cada dia que passava trazia consigo uma
                nova
                lição. No entanto, a determinação de Guilherme e sua equipe foram cruciais. Nós aprendemos com
                os
                contra
            ...
            <p>
                ...
                inovação.
                Além de utilizarmos ingredientes frescos, temos uma identidade própria, nós contamos também com
                uma
                abordagem única para a personalização dos hambúrgueres. Os clientes podem escolher entre uma
                variedade
                de pães, carnes, queijos e molhos para criar seus hambúrgueres perfeitos, tornando cada refeição
                uma
            ...
            <p>
                ...
                espalhadas
                pela cidade e uma crescente base de fãs online, nós continuamos a servir hambúrgueres deliciosos
                com
                um
...
<div class="centralizar">
    <main class="fundinho2" id="experiencia">
        <div>
            <H3>Minhas Experiências Com o PI</H3>
            ...
            <p>
                ...
                TI21 e os professores VAGNER e PAULO. Com isso me despeço de todos meus amigos e espero reencontra-los algum dia...
